...
if __name__ == "__main__":
    ...
    infile = join(script_directory, "../vn_data/input/per_gene/ERBB4.chr2.csv")
    outfile_parsed_INFO = join(script_directory, "data/ERBB4.chr2.parsed.INFO.csv")
    outfile_linked_clinvar = join(script_directory, "data/ERBB4.chr2.linked_clinvar.csv")
