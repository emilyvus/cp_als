...
outputfile_all_genes = join(script_directory,"results/variant_stats_all_genes.csv")
odf = pd.DataFrame(
    [
...
outputfile_all_genomes = join(script_directory,"results/variant_stats_all_genomes.csv")
