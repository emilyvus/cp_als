...
def attic():
     outputfile= join(root_dir,"analysis/20250816/per_genome_variant_count_all_populations.csv")
     mdf = create_per_genome_variant_mean_all_population_df(root_dir=root_dir,genomes=genomes,outputfile=outputfile)
...
def mean_variant_all_genomes_statistical_analysis(root_dir):
     ...
     For each population, it calculates the variant mean for each gene & across all genomes. 
     ...
     # outputfile= join(root_dir,"analysis/20250816/per_genome_variant_count_all_populations.csv")
     # all_dict = create_total_variant_count_all_population_df(root_dir=root_dir,genomes=genomes,outputfile=outputfile)
...
def total_variant_all_genomes_statistical_analysis(root_dir):
     """
     This method works for all populations.
     For each population, it calculates the variant total counts for each gene & across all genomes. 
     It then performs statistical analysis.
